...
describe('A FigureCalculator', () => {
  it('should contain calculateRectanglePerimeter, calculateRecatangleArea, calculateTrianglePerimaeter, and calculateTriangleArea functions', () => {
  ...
  describe('A calculateRectanglePerimeter function', () => {
    ...
    it('should throw error when given with non-number parameters', () => {
      ...
      expect(() => figureCalculator.calculateRectanglePerimeter(true, '1')).toThrowError();
      expect(() => figureCalculator.calculateRectanglePerimeter([], {})).toThrowError();
    });
